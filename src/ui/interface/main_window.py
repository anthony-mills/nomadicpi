...
class Ui_NomadicPI(object):
    def setupUi(self, NomadicPI):
        ...
        self.SystemButton.setIcon(icon)
        ...
        self.SystemLoadAvg.setGeometry(QtCore.QRect(20, 130, 231, 21))
        self.SystemLoadAvg.setObjectName("SystemLoadAvg")
        self.label_2 = QtWidgets.QLabel(self.system_status)
        ...
        self.SystemMemoryAvail.setGeometry(QtCore.QRect(20, 160, 221, 21))
        self.SystemMemoryAvail.setObjectName("SystemMemoryAvail")
        self.label_3 = QtWidgets.QLabel(self.system_status)
        ...
        self.label_4 = QtWidgets.QLabel(self.system_status)
        self.label_4.setGeometry(QtCore.QRect(10, 320, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Condensed")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.SystemMemoryUsed.setGeometry(QtCore.QRect(260, 150, 201, 21))
        self.SystemMemoryUsed.setObjectName("SystemMemoryUsed")
        self.SystemMemoryUtilisation = QtWidgets.QLabel(self.system_status)
        self.SystemMemoryUtilisation.setGeometry(QtCore.QRect(470, 150, 201, 21))
        ...
        self.SystemCPUUsage.setGeometry(QtCore.QRect(260, 130, 201, 21))
        self.SystemCPUUsage.setObjectName("SystemCPUUsage")
        self.SystemCPUFreq = QtWidgets.QLabel(self.system_status)
        self.SystemCPUFreq.setGeometry(QtCore.QRect(470, 130, 201, 21))
        self.SystemCPUFreq.setObjectName("SystemCPUFreq")
        self.label_5 = QtWidgets.QLabel(self.system_status)
        self.label_5.setGeometry(QtCore.QRect(10, 180, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Condensed")
        font.setPointSize(16)
        font.setBold(True)
    ...
    def retranslateUi(self, NomadicPI):
        ...
        self.label_2.setText(_translate("NomadicPI", "System Info"))
        self.SystemMemoryAvail.setText(_translate("NomadicPI", "Memory Available:"))
        self.label_3.setText(_translate("NomadicPI", "MPD"))
        self.label_4.setText(_translate("NomadicPI", "Network"))
        ...
        self.label_5.setText(_translate("NomadicPI", "Disks"))
