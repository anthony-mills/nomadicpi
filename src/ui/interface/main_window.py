...
class Ui_NomadicPI(object):
    def setupUi(self, NomadicPI):
        ...
        self.NetworkReturnHome = QtWidgets.QPushButton(self.network_status)
        self.NetworkReturnHome.setGeometry(QtCore.QRect(690, 10, 101, 71))
        self.NetworkReturnHome.setText("")
        icon = QtGui.QIcon.fromTheme("gohome")
        self.NetworkReturnHome.setIcon(icon)
        self.NetworkReturnHome.setIconSize(QtCore.QSize(80, 80))
        self.NetworkReturnHome.setObjectName("NetworkReturnHome")
        self.NetworkPlaceHolder = QtWidgets.QLabel(self.network_status)
        self.NetworkPlaceHolder.setGeometry(QtCore.QRect(10, 10, 131, 16))
        self.NetworkPlaceHolder.setObjectName("NetworkPlaceHolder")
    ...
    def retranslateUi(self, NomadicPI):
        ...
        self.NetworkReturnHome.setToolTip(_translate("NomadicPI", "Application Home"))
        self.NetworkReturnHome.setStatusTip(_translate("NomadicPI", "Scroll Up"))
        self.NetworkPlaceHolder.setText(_translate("NomadicPI", "Network Status"))
