...
class Ui_NomadicPI(object):
    def setupUi(self, NomadicPI):
        ...
        self.SystemLoadAvg.setGeometry(QtCore.QRect(20, 50, 231, 21))
        ...
        self.SystemMemoryAvail.setGeometry(QtCore.QRect(20, 70, 221, 21))
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 210, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Condensed")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.SystemMemoryUsed.setGeometry(QtCore.QRect(260, 70, 201, 21))
        self.SystemMemoryUsed.setObjectName("SystemMemoryUsed")
        self.SystemMemoryUtilisation = QtWidgets.QLabel(self.system_status)
        self.SystemMemoryUtilisation.setGeometry(QtCore.QRect(470, 70, 201, 21))
        ...
        self.SystemCPUUsage.setGeometry(QtCore.QRect(260, 50, 201, 21))
        self.SystemCPUUsage.setObjectName("SystemCPUUsage")
        self.SystemCPUFreq = QtWidgets.QLabel(self.system_status)
        self.SystemCPUFreq.setGeometry(QtCore.QRect(470, 50, 201, 21))
    ...
    def retranslateUi(self, NomadicPI):
        ...
        self.SystemButton.setToolTip(_translate("NomadicPI", "Network Status"))
        ...
        self.label_2.setText(_translate("NomadicPI", "System"))
