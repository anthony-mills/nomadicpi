...
class Ui_NomadicPI(object):
    def setupUi(self, NomadicPI):
        ...
        self.PageUpButton = QtWidgets.QPushButton(self.browse_files)
        self.PageUpButton.setGeometry(QtCore.QRect(10, 445, 90, 28))
        self.PageUpButton.setObjectName("PageUpButton")
        self.PageDownButton = QtWidgets.QPushButton(self.browse_files)
        self.PageDownButton.setGeometry(QtCore.QRect(580, 445, 90, 28))
        self.PageDownButton.setObjectName("PageDownButton")
        ...
        self.GpsSatellites.setGeometry(QtCore.QRect(350, 40, 311, 31))
        self.GpsSatellites.setObjectName("GpsSatellites")
        self.GpsFixType = QtWidgets.QLabel(self.car_location)
        self.GpsFixType.setGeometry(QtCore.QRect(30, 40, 301, 31))
        self.GpsFixType.setObjectName("GpsFixType")
        self.CurAltitude = QtWidgets.QLabel(self.car_location)
        self.CurAltitude.setGeometry(QtCore.QRect(30, 120, 311, 31))
        self.CurAltitude.setObjectName("CurAltitude")
        self.CurLat = QtWidgets.QLabel(self.car_location)
        self.CurLat.setGeometry(QtCore.QRect(30, 80, 311, 31))
        self.CurLat.setObjectName("CurLat")
        self.HorizontalSpeed = QtWidgets.QLabel(self.car_location)
        self.HorizontalSpeed.setGeometry(QtCore.QRect(350, 160, 331, 31))
        self.HorizontalSpeed.setObjectName("HorizontalSpeed")
        self.VerticalSpeed = QtWidgets.QLabel(self.car_location)
        self.VerticalSpeed.setGeometry(QtCore.QRect(30, 160, 311, 31))
        self.VerticalSpeed.setObjectName("VerticalSpeed")
        self.LocalTime = QtWidgets.QLabel(self.car_location)
        self.LocalTime.setGeometry(QtCore.QRect(30, 200, 311, 31))
        self.LocalTime.setObjectName("LocalTime")
        self.GpsHeading = QtWidgets.QLabel(self.car_location)
        self.GpsHeading.setGeometry(QtCore.QRect(350, 120, 311, 31))
        self.GpsHeading.setObjectName("GpsHeading")
        self.UtcTime = QtWidgets.QLabel(self.car_location)
        self.UtcTime.setGeometry(QtCore.QRect(350, 200, 331, 31))
        self.UtcTime.setObjectName("UtcTime")
        self.CurLong = QtWidgets.QLabel(self.car_location)
        self.CurLong.setGeometry(QtCore.QRect(350, 80, 311, 31))
        self.CurLong.setObjectName("CurLong")
        self.line = QtWidgets.QFrame(self.car_location)
        self.line.setGeometry(QtCore.QRect(30, 240, 631, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.GpsStatusHeading = QtWidgets.QLabel(self.car_location)
        self.GpsStatusHeading.setGeometry(QtCore.QRect(30, 10, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.GpsStatusHeading.setFont(font)
        self.GpsStatusHeading.setObjectName("GpsStatusHeading")
        self.GpsLogHeading = QtWidgets.QLabel(self.car_location)
        self.GpsLogHeading.setGeometry(QtCore.QRect(30, 270, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.GpsLogHeading.setFont(font)
        self.GpsLogHeading.setObjectName("GpsLogHeading")
        self.GPSLogPoints = QtWidgets.QLabel(self.car_location)
        self.GPSLogPoints.setGeometry(QtCore.QRect(30, 300, 301, 31))
        self.GPSLogPoints.setObjectName("GPSLogPoints")
        self.GPSLogDateRange = QtWidgets.QLabel(self.car_location)
        self.GPSLogDateRange.setGeometry(QtCore.QRect(350, 300, 301, 31))
        self.GPSLogDateRange.setObjectName("GPSLogDateRange")
        self.GPSLogDistance = QtWidgets.QLabel(self.car_location)
        self.GPSLogDistance.setGeometry(QtCore.QRect(30, 340, 301, 31))
        self.GPSLogDistance.setObjectName("GPSLogDistance")
        self.GPSLogAvgSpeed = QtWidgets.QLabel(self.car_location)
        self.GPSLogAvgSpeed.setGeometry(QtCore.QRect(350, 340, 301, 31))
        self.GPSLogAvgSpeed.setObjectName("GPSLogAvgSpeed")
        self.GPSLogAvgAltitude = QtWidgets.QLabel(self.car_location)
        self.GPSLogAvgAltitude.setGeometry(QtCore.QRect(30, 380, 301, 31))
        self.GPSLogAvgAltitude.setObjectName("GPSLogAvgAltitude")
        self.GPSLogMaxAltitude = QtWidgets.QLabel(self.car_location)
        self.GPSLogMaxAltitude.setGeometry(QtCore.QRect(350, 380, 301, 31))
        self.GPSLogMaxAltitude.setObjectName("GPSLogMaxAltitude")
        self.ResetTripLogButton = QtWidgets.QPushButton(self.car_location)
        self.ResetTripLogButton.setGeometry(QtCore.QRect(690, 400, 101, 71))
        self.ResetTripLogButton.setText("")
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(self.base_path + "visual_elements/icons/discard.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ResetTripLogButton.setIcon(icon20)
        self.ResetTripLogButton.setIconSize(QtCore.QSize(80, 80))
        self.ResetTripLogButton.setObjectName("ResetTripLogButton")
        self.ExportGPSLogButton = QtWidgets.QPushButton(self.car_location)
        self.ExportGPSLogButton.setGeometry(QtCore.QRect(690, 320, 101, 71))
        self.ExportGPSLogButton.setText("")
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(self.base_path + "visual_elements/icons/download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ExportGPSLogButton.setIcon(icon21)
        self.ExportGPSLogButton.setIconSize(QtCore.QSize(80, 80))
        self.ExportGPSLogButton.setObjectName("ExportGPSLogButton")
...
"color: rgb(186, 189, 182);")
        ...
        self.NightPlayButton.setStyleSheet("background-color: rgba(0, 0, 0, 0.4); \n"
...
"border-radius: 5px;")
        ...
        self.NightTrackSkipButton.setAutoFillBackground(False)
        self.NightTrackSkipButton.setStyleSheet("background-color: rgba(0, 0, 0, 0.4); \n"
"border: 1px solid #404040;\n"
"border-radius: 5px;")
        ...
        self.NightStopButton.setStyleSheet("background-color: rgba(0, 0, 0, 0.4); \n"
"border: 1px solid #404040;\n"
"border-radius: 5px;")
        ...
        self.NightSwitchMode.setStyleSheet("background-color: rgba(0, 0, 0, 0.4); \n"
"border: 1px solid #404040;\n"
"border-radius: 5px;")
        self.NightSwitchMode.setText("")
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(self.base_path + "visual_elements/icons/sunny.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.NightSwitchMode.setIcon(icon22)
    ...
    def retranslateUi(self, NomadicPI):
        ...
        self.PageUpButton.setText(_translate("NomadicPI", "Page Up"))
        self.PageDownButton.setText(_translate("NomadicPI", "Page Down"))
        ...
        self.GpsStatusHeading.setText(_translate("NomadicPI", "GPS Status"))
        self.GpsLogHeading.setText(_translate("NomadicPI", "GPS Log"))
        self.GPSLogPoints.setText(_translate("NomadicPI", "Data Points"))
        self.GPSLogDateRange.setText(_translate("NomadicPI", "Date Range"))
        self.GPSLogDistance.setText(_translate("NomadicPI", "Distance"))
        self.GPSLogAvgSpeed.setText(_translate("NomadicPI", "Average Speed"))
        self.GPSLogAvgAltitude.setText(_translate("NomadicPI", "Average Altitude"))
        self.GPSLogMaxAltitude.setText(_translate("NomadicPI", "Max Altitude"))
        self.ResetTripLogButton.setToolTip(_translate("NomadicPI", "Reset Trip Log"))
        self.ResetTripLogButton.setStatusTip(_translate("NomadicPI", "Scroll Up"))
        self.ExportGPSLogButton.setToolTip(_translate("NomadicPI", "Export Trip Log"))
        self.ExportGPSLogButton.setStatusTip(_translate("NomadicPI", "Scroll Up"))
